...
class CollaborationConverter {
    ...
    buildParticipant(bpmnElements) {
        ensureIsArray(bpmnElements).forEach(participant => this.convertedElements.registerPool(new ShapeBpmnElement(participant.id, participant.name, ShapeBpmnElementKind.POOL), participant.processRef));
    }
    ...
    buildFlowNodeBpmnElements(bpmnElements, kind, parentId, processId) {
        ensureIsArray(bpmnElements).forEach(bpmnElement => {
            ...
            if (ShapeUtil.isEvent(kind)) {
                ...
                shapeBpmnElement = new ShapeBpmnEventBasedGateway(bpmnElement.id, eventBasedGatewayBpmnElement.name, parentId, eventBasedGatewayBpmnElement.instantiate, ShapeBpmnEventBasedGatewayKind[eventBasedGatewayBpmnElement.eventGatewayType]);
            }
