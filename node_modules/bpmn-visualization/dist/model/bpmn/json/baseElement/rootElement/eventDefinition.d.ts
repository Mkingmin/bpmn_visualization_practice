...
export declare type TEventDefinition = TRootElement;
...
export declare type TCancelEventDefinition = TEventDefinition;
...
export declare type TTerminateEventDefinition = TEventDefinition;
