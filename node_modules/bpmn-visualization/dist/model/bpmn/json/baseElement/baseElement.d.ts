...
export declare type TAuditing = TBaseElement;
...
export declare type TMonitoring = TBaseElement;
...
declare enum tRelationshipDirection {
    None = "None",
    Forward = "Forward",
    Backward = "Backward",
    Both = "Both"
...
export declare type TRendering = TBaseElement;
export {};
