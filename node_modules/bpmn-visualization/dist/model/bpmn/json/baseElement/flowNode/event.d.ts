...
export declare type TIntermediateCatchEvent = TCatchEvent;
...
export declare type TImplicitThrowEvent = TThrowEvent;
export declare type TIntermediateThrowEvent = TThrowEvent;
export declare type TEndEvent = TThrowEvent;
