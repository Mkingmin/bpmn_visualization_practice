...
export interface TGateway extends TFlowNode {
    gatewayDirection?: tGatewayDirection;
}
...
export interface TEventBasedGateway extends TGateway {
    instantiate?: boolean;
    eventGatewayType?: tEventBasedGatewayType;
}
...
export declare type TParallelGateway = TGateway;
declare enum tEventBasedGatewayType {
    Exclusive = "Exclusive",
    Parallel = "Parallel"
}
declare enum tGatewayDirection {
